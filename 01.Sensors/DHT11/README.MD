...
<br />
- Go to the library Manager inside the Arduino IDE. Search and download the DHT11 library by Dhruba Saha.
...
This sketch will print the temperature and relative humidity values to the serial monitor.
