# IR Distance Sensor 20-150CM - GP2Y0A02YK0F

![Image of Infrared Distance Sensor](./Images/IR-proximity-sensor.jpeg)

In this tutorial we will use the Sharp IR sensor (GP2Y0A02YK0F) to measure distance from an object.
...
In this tutorial we will try to measure the distance from an object (20~150cm).
...
void loop() {
  ...
  float distance = 60.374 * pow(volts, -1.16); // fit for GP2Y0A02
